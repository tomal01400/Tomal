                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption">
                            <div class="container py-4">
                                <div class="row g-5">
                                    <div class="col-lg-7 fadeInLeft animated" data-animation="fadeInLeft" data-delay="1s" style="animation-delay: 1s;">
                                        
                                    </div>
                                    <div class="col-lg-6 d-none d-lg-flex fadeInRight animated" data-animation="fadeInRight" data-delay="1s" style="animation-delay: 1s;">
                                        <div class="text-start">
                                            <h1 class="display-5 text-white">Get 15% off your rental Plan your trip now</h1>
                                            <p>Treat yourself in BANGLADESH</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="categories-item p-4">
                        <div class="categories-item-inner">
                            <div class="categories-img rounded-top">
                                <img src="{{ asset('/'.$value->image) }}" class="img-fluid w-100 rounded-top" alt="" >
                            </div>
                            <div class="categories-content rounded-bottom p-4">
                                ...
                                <div class="mb-4">
                                    <h4 class="bg-white text-primary rounded-pill py-2 px-4 mb-0">{{$value->price}}$</h4>
                                </div>
                                <div class="row gy-2 gx-0 text-center mb-4">
                                    
                                    <div class="col-6">
                                        <i class="fa fa-road text-dark"></i> <span class="text-body ms-1 ">Start Date: {{$value->start_date}}</span>
                                    </div>
                                    <div class="col-6">
                                        <i class="fa fa-road text-dark"></i> <span class="text-body ms-1">End Date: {{$value->end_date}}</span>
                                    </div>
                                    <div class="col-6">
                                        <i class="fa fa-road text-dark"></i> <span class="text-body ms-1">Status: {{$value->status}}</span>
                                    </div>
                                    <div class="col-6">
                                        <i class="fa fa-road text-dark"></i> <span class="text-body ms-1">End Date: {{$value->end_date}}</span>
                                    </div>
            ...
            <div class="container py-5">
                ...
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-lg-12 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                        <img src="{{asset('frontend/img/features-img.png')}}" class="img-fluid w-100" style="object-fit: cover;" alt="Img">
                    </div>
                    <div class="col-xl-4">
                        <div class="row gy-4 gx-0">
                            <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-7">
                                    <div class="d-flex align-items-center">
                                        <img src="{{asset('frontend/img/attachment-img.jpg')}}" class="img-fluid rounded-circle border border-4 border-secondary" style="width: 100px; height: 100px;" alt="Image">
                                        <div class="ms-4">
            ...
            <div class="container pb-5">
                ...
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="testimonial-inner p-4">
                            <img src="{{asset('frontend/img/testimonial-2.jpg')}}" class="img-fluid" alt="">
                            <div class="ms-4">
                                <h4>Person Name</h4>
                                <p>Profession</p>
                                <div class="d-flex text-primary">
                    ...
                    <div class="testimonial-item">
                        ...
                        <div class="testimonial-inner p-4">
                            <img src="{{asset('frontend/img/testimonial-3.jpg" class="img-fluid" alt="">
                            <div class="ms-4">
                                <h4>Person Name</h4>
                                <p>Profession</p>
                                <div class="d-flex text-primary">
